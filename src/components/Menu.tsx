...
const menuItems: MenuSection[] = [
  {
    ...
    items: [
      ...
      { icon: "/calendar-off.png", label: "Holidays",      href: "/list/holidays",       visible: ["admin","teacher","student","parent"] },
      { icon: "/megaphone.png",    label: "Announcements", href: "/list/announcements",  visible: ["admin","teacher","student","parent"] },
    ],
  },
  {
    title: "PEOPLE",
  ...
  },
  {
    title: "ACADEMICS",
    items: [
      { icon: "/book.png",         label: "Subjects",      href: "/list/subjects",       visible: ["admin"] },
      { icon: "/building.png",     label: "Classes",       href: "/list/classes",        visible: ["admin","teacher"] },
      ...
      { icon: "/clipboard.png",    label: "Assignments",   href: "/list/assignments",    visible: ["admin","teacher","student","parent"] },
      { icon: "/chart.png",        label: "Results",       href: "/list/results",        visible: ["admin","teacher","student","parent"] },
      { icon: "/checkbox.png",     label: "Attendance",    href: "/list/attendance",     visible: ["admin","teacher","student","parent"] },
      { icon: "/academic.png",     label: "Academic Years",href: "/list/academic-years", visible: ["admin"] },
      { icon: "/promote.png",      label: "Bulk Promote",  href: "/list/students/bulk-promote", visible: ["admin"] },
    ],
  },
  {
    title: "CONTENT & MARKETING",
    items: [
      { icon: "/banner.png",       label: "Banners",       href: "/list/banners",        visible: ["admin"] },
      { icon: "/photo.png",        label: "Photo Gallery", href: "/list/photo-gallery",  visible: ["admin"] },
      { icon: "/quote.png",        label: "Testimonials",  href: "/list/testimonials",   visible: ["admin","student"] },
      { icon: "/medal.png",        label: "Achievements",  href: "/list/achievements",   visible: ["admin"] },
      { icon: "/sports.png",       label: "Sports Programs",href: "/list/sports-programs",visible: ["admin"] },
    ],
  },
  {
    title: "CAREERS",
    items: [
      { icon: "/briefcase.png",    label: "Job Openings",     href: "/list/job-openings",     visible: ["admin"] },
      { icon: "/cv.png",           label: "Job Applications", href: "/list/job-applications", visible: ["admin"] },
    ],
  },
  {
    title: "OTHER",
