...
export const CardCarousel = ({ data }) => {
    ...
    return (
        data.map((item, index) => (
            <div className="testimonial-item" key={index} style={{ height: '100%', display: 'flex', flexDirection: 'column' }}>
                ...
                <div className="testimonial-content">
                    <div className="testimonial-author-img">
                        <Image src={item.image} alt="testimonial DP" height={200} width={200} />
                    </div>
