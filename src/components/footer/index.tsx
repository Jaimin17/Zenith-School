...
const Footer: React.FC = () => {
  const quickLinksTitle: string[] = ["About Us", "Timeline", "Curriculum", "Gallery", "Contact Us", "Careers"];
  const quickLinks: string[] = ["/about/from-principal-desk", "/about/timeline", "/academics/curriculum", "/gallery/photos", "/contact-us", "/careers"];
