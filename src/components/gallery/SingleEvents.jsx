                    ...
                    <div className="row">
                        <div className="col-lg-8">
                            <div className="event-details">
                                <Image src={eventData.singleImage} alt="event image" height={800} width={900} />
                            ...
                            <div className="widget event-single-info">
                                ...
                                <div className="event-content">
                                    ...
                                    <div className="event-content-single">
                                        ...
                                        <p><i className="far fa-map-marker-alt"></i> {eventData.location}</p>
                                    </div>
                                    <div className="event-content-single">
                                        <h5><a href="#">Event Cost</a></h5>
                                        <p><i className="far fa-usd-circle"></i> {eventData.cost}</p>
                                    </div>

                                    <a href="#" className="theme-btn mt-4">Book Now <i className="fas fa-arrow-right-long"></i></a>
                                </div>
                            </div>
                            <div className="widget event-author">
                                <h4 className="widget-title">Event Organizer</h4>
                                <div className="event-author-info">
                                    {/* <Image src="assets/img/event/author.jpg" alt=""> */}
                                    <Image src={eventData.organizer.image} alt="eventOrganizer" width={100} height={100} />
