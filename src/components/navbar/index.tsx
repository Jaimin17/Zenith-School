...
const Navbar: React.FC = () => {
  ...
  const [mobileExpand, setMobileExpand] = useState<MobileExpandState>({
    overview: false,
    about: false,
    academics: false,
    gallery: false,
  ...
  const toggleMobile = (key: keyof MobileExpandState) =>
        ...
        >
          ...
          >
            ...
            <Box className="nav-right-btn mt-2">
              <Link href="/admission" className="theme-btn">
